      ...
      <section className="py-20 md:py-32 bg-navy-light border-b border-primary/20">
        <Container>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            {/* GOLD STACK: Automation philosophy */}
            <div className="text-center pt-8">
              <p className="text-xl md:text-2xl font-bold gradient-text">
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-card/80 backdrop-blur border border-border hover:border-primary/50 transition-all duration-300 space-y-4">
                <h3 className="text-xl font-bold">Working prototype on day one</h3>
              ...
              {/* MVP in a week */}
              <div className="p-8 rounded-3xl bg-card/80 backdrop-blur border border-border hover:border-primary/50 transition-all duration-300 space-y-4">
                <h3 className="text-xl font-bold">MVP in a week</h3>
                <p className="text-foreground/70 leading-relaxed">
              ...
              {/* Credits */}
              <div className="p-8 rounded-3xl bg-card/80 backdrop-blur border border-border hover:border-primary/50 transition-all duration-300 space-y-4">
                <h3 className="text-xl font-bold">Credits, not retainers</h3>
                <p className="text-foreground/70 leading-relaxed">
              ...
              {/* Built around you */}
              <div className="p-8 rounded-3xl bg-card/80 backdrop-blur border border-border hover:border-primary/50 transition-all duration-300 space-y-4">
                <h3 className="text-xl font-bold">Built around your way of working</h3>
                <p className="text-foreground/70 leading-relaxed">
              ...
              {/* Confidential */}
              <div className="p-8 rounded-3xl bg-card/80 backdrop-blur border border-border hover:border-primary/50 transition-all duration-300 space-y-4">
                <h3 className="text-xl font-bold">Confidential and secure</h3>
                <p className="text-foreground/70 leading-relaxed">
                  NDAs signed before we start. Your data stays private. Your IP stays yours. Trust comes first.
                </p>
              </div>

              {/* GOLD STACK: Momentum as a Service */}
              <div className="p-8 rounded-3xl bg-gradient-to-br from-primary/20 to-purple/20 backdrop-blur border border-primary/50 transition-all duration-300 space-y-4">
                <h3 className="text-xl font-bold gradient-text">Momentum as a Service</h3>
            ...
            <div className="text-center p-8 rounded-3xl bg-gradient-to-r from-purple/10 to-primary/10 border border-primary/30 space-y-4">
              <p className="text-xl md:text-2xl font-bold gradient-text">
